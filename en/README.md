...
|----------|--------------|
| Node Binary | https://github.com/PIJSChain/pijs/releases/tag/v1.25.8 |
| Genesis Config | https://github.com/PIJSChain/pijs/releases/download/v1.25.8/genesis.json |
| Bootstrap Nodes | https://github.com/PIJSChain/pijs/releases/download/v1.25.8/bootnodes.txt |
...
curl -LO https://raw.githubusercontent.com/PIJSChain/chain-stake-guidelines/main/en/scripts/upgrade-node.sh
...
3. **Download new client**
   ...
   <https://github.com/PIJSChain/pijs/releases/tag/v1.25.8>

   ```bash
   # Example for Linux x86_64
   cd ~/pijs-node/bin
   curl -LO https://github.com/PIJSChain/pijs/releases/download/v1.25.8/geth-linux-amd64
...
4. **Download new genesis config**
   ...
   ```bash
   cd ~/pijs-node
   curl -LO https://github.com/PIJSChain/pijs/releases/download/v1.25.8/genesis.json
   ```
...
**Download URL**: <https://github.com/PIJSChain/pijs/releases/tag/v1.25.8>

| Platform | Filename |
|----------|----------|
| Linux x86_64 | geth-v1.25.8-linux-amd64.tar.gz |
| Linux ARM64 | geth-v1.25.8-linux-arm64.tar.gz |
| macOS Intel | geth-v1.25.8-darwin-amd64.tar.gz |
| macOS Apple Silicon | geth-v1.25.8-darwin-arm64.tar.gz |
| Windows x86_64 | geth-v1.25.8-windows-amd64.tar.gz |
...
```bash
# Download
wget https://github.com/PIJSChain/pijs/releases/download/v1.25.8/geth-v1.25.8-linux-amd64.tar.gz

# Extract
tar -xzf geth-v1.25.8-linux-amd64.tar.gz
...
```bash
wget https://github.com/PIJSChain/pijs/releases/download/v1.25.8/geth-v1.25.8-linux-arm64.tar.gz
tar -xzf geth-v1.25.8-linux-arm64.tar.gz
sudo mv geth bootnode /usr/local/bin/
geth version
```
...
```bash
curl -LO https://github.com/PIJSChain/pijs/releases/download/v1.25.8/geth-v1.25.8-darwin-amd64.tar.gz
tar -xzf geth-v1.25.8-darwin-amd64.tar.gz
sudo mv geth bootnode /usr/local/bin/
geth version
```
...
```bash
curl -LO https://github.com/PIJSChain/pijs/releases/download/v1.25.8/geth-v1.25.8-darwin-arm64.tar.gz
tar -xzf geth-v1.25.8-darwin-arm64.tar.gz
sudo mv geth bootnode /usr/local/bin/
geth version
```
...
1. Download `geth-v1.25.8-windows-amd64.tar.gz`
...
# Windows PowerShell
Invoke-WebRequest -Uri "https://github.com/PIJSChain/pijs/releases/download/v1.25.8/genesis.json" -OutFile "genesis.json"
```
...
curl -LO https://github.com/PIJSChain/pijs/releases/download/v1.25.8/bootnodes.txt
