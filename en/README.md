...
|----------|--------------|
| Node Binary | https://github.com/PIJSChain/pijs/releases/tag/v1.25.7 |
| Genesis Config | https://github.com/PIJSChain/pijs/releases/download/v1.25.7/genesis.json |
| Bootstrap Nodes | https://github.com/PIJSChain/pijs/releases/download/v1.25.7/bootnodes.txt |
...
**Download URL**: <https://github.com/PIJSChain/pijs/releases/tag/v1.25.7>
...
1. Download `geth-v1.25.7-windows-amd64.tar.gz`
