...
| 创世配置 | https://[CONFIG_HOST]/genesis.json |
| 引导节点 | 见下方 [引导节点用户手册/共识节点部署指南/README.md配置](#引导节点配置) |
