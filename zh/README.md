...
| 资源 | 下载地址 |
|------|---------|
| 节点程序 | https://github.com/PIJSChain/pijs/releases/tag/v1.25.8 |
| 创世配置 | https://github.com/PIJSChain/pijs/releases/download/v1.25.8/genesis.json |
| 引导节点 | https://github.com/PIJSChain/pijs/releases/download/v1.25.8/bootnodes.txt |
...
**下载地址**: <https://github.com/PIJSChain/pijs/releases/tag/v1.25.8>
...
1. 下载 `geth-v1.25.8-windows-amd64.tar.gz`
