...
# 不修改链数据，不更新创世配置
# ============================================================
# 仅匹配 PIJSChain/pijs 中后缀**非** `-mainnet` 的最新 release tag。
# 该仓库同时承载测试网（无后缀 / `-testnet`）与主网（`-mainnet`）release，
# 此脚本会自动跳过主网 tag，避免测试网用户误抓主网版本。
# ============================================================
...
$ReleaseExcludePattern = "*-mainnet"  # 排除主网 tag
...
function Get-LatestVersion {
    ...
    Write-Success "最新测试网版本: $($script:LatestVersion)"
}
