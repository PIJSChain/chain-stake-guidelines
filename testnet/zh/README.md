...
| 资源 | 下载地址 |
|------|---------|
| 节点程序 | https://github.com/PIJSChain/pijs/releases/tag/v1.26.0 |
| 创世配置 | https://github.com/PIJSChain/pijs/releases/download/v1.26.0/genesis.json |
| 引导节点 | https://github.com/PIJSChain/pijs/releases/download/v1.26.0/bootnodes.txt |
...
```bash
# 下载升级脚本
curl -LO https://raw.githubusercontent.com/PIJSChain/chain-stake-guidelines/main/testnet/zh/scripts/upgrade-node.sh
...
```powershell
# 下载升级脚本
Invoke-WebRequest -Uri "https://raw.githubusercontent.com/PIJSChain/chain-stake-guidelines/main/testnet/zh/scripts/upgrade-node.ps1" -OutFile "upgrade-node.ps1"
...
```bash
# 下载脚本
curl -LO https://raw.githubusercontent.com/PIJSChain/chain-stake-guidelines/main/testnet/zh/scripts/update-node-binaries.sh
...
```powershell
# 下载脚本
Invoke-WebRequest -Uri "https://raw.githubusercontent.com/PIJSChain/chain-stake-guidelines/main/testnet/zh/scripts/update-node-binaries.ps1" -OutFile "update-node-binaries.ps1"
...
```bash
# 下载一键部署脚本
curl -LO https://raw.githubusercontent.com/PIJSChain/chain-stake-guidelines/main/testnet/zh/scripts/setup-node-testnet.sh
...
```powershell
# 下载一键部署脚本
Invoke-WebRequest -Uri "https://raw.githubusercontent.com/PIJSChain/chain-stake-guidelines/main/testnet/zh/scripts/setup-node-testnet.ps1" -OutFile "setup-node-testnet.ps1"
...
**下载地址**: <https://github.com/PIJSChain/pijs/releases/tag/v1.26.0>
...
1. 下载 `geth-v1.26.0-windows-amd64.tar.gz`
