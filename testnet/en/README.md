...
curl -LO https://raw.githubusercontent.com/PIJSChain/chain-stake-guidelines/main/testnet/en/scripts/upgrade-node.sh
...
```powershell
# Download upgrade script
Invoke-WebRequest -Uri "https://raw.githubusercontent.com/PIJSChain/chain-stake-guidelines/main/testnet/en/scripts/upgrade-node.ps1" -OutFile "upgrade-node.ps1"
...
```bash
# Download script
curl -LO https://raw.githubusercontent.com/PIJSChain/chain-stake-guidelines/main/testnet/en/scripts/update-node-binaries.sh
...
```powershell
# Download script
Invoke-WebRequest -Uri "https://raw.githubusercontent.com/PIJSChain/chain-stake-guidelines/main/testnet/en/scripts/update-node-binaries.ps1" -OutFile "update-node-binaries.ps1"
...
curl -LO https://raw.githubusercontent.com/PIJSChain/chain-stake-guidelines/main/testnet/en/scripts/setup-node-testnet.sh
...
```powershell
# Download deployment script
Invoke-WebRequest -Uri "https://raw.githubusercontent.com/PIJSChain/chain-stake-guidelines/main/testnet/en/scripts/setup-node-testnet.ps1" -OutFile "setup-node-testnet.ps1"
